...
use super::script::{CheckSig, OriginalDepositScript, SpendableScript, TimelockScript};
...
pub fn generate_deposit_address(
    ...
    let deposit_script =
        OriginalDepositScript::new(nofn_xonly_pk, user_evm_address, amount).to_script_buf();
