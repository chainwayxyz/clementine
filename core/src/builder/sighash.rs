            ...
            operators.iter().enumerate()
        {
            ...
            for time_tx_idx in 0..config.num_time_txs {
                ...
                for kickoff_idx in 0..config.num_kickoffs_per_timetx {
                    ...
                    let public_hashes = db.get_watchtowers_public_hashes(None, operator_idx as i32, time_tx_idx as i32, kickoff_idx as i32).await?.ok_or(BridgeError::WatchtowerPublicHashesNotFound(operator_idx as i32, time_tx_idx as i32, kickoff_idx as i32))?;
