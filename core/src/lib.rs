...
//!
//! - The [`crate::header_chain_prover`] module accepts Bitcoin block headers
...
//!
//! - The [`crate::extended_rpc`] module provides a client that talks with
//!   the Bitcoin node.
//! - The [`crate::citrea`] module provides a client for interacting with Citrea.
//! - The [`crate::bitvm_client`] module provides a client for BitVM.
//! - The [`crate::database`] module provides a database interface for
