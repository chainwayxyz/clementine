...
pub const REGTEST_PARAMSET: ProtocolParamset = ProtocolParamset {
    ...
    num_watchtowers: 3,
    user_takes_after: 200,
    operator_challenge_timeout_timelock: BLOCKS_PER_HOUR,
    operator_challenge_nack_timelock: BLOCKS_PER_HOUR * 3,
    disprove_timeout_timelock: BLOCKS_PER_HOUR * 5,
    assert_timeout_timelock: BLOCKS_PER_HOUR * 4,
    operator_reimburse_timelock: 2,
    watchtower_challenge_timeout_timelock: BLOCKS_PER_HOUR * 2,
    time_to_send_watchtower_challenge: BLOCKS_PER_HOUR * 3 / 2,
    time_to_disprove: BLOCKS_PER_HOUR * 4 + BLOCKS_PER_HOUR / 2,
    finality_depth: 1,
    start_height: 201,
};
