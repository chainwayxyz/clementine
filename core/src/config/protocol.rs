...
pub const REGTEST_TEST_BRIDGE_CIRCUIT_CONSTANT: [u8; 32] = [
    39, 50, 234, 59, 93, 103, 178, 24, 45, 100, 113, 23, 39, 103, 20, 31, 153, 56, 176, 177, 243,
    7, 9, 214, 112, 247, 188, 211, 143, 60, 245, 98,
];

pub const REGTEST_BRIDGE_CIRCUIT_CONSTANT: [u8; 32] = [
    27, 187, 161, 240, 96, 212, 74, 108, 247, 13, 81, 24, 141, 224, 177, 41, 22, 92, 42, 124, 126,
    67, 251, 248, 174, 4, 34, 71, 84, 245, 91, 151,
];

pub const SIGNET_BRIDGE_CIRCUIT_CONSTANT: [u8; 32] = [
    16, 134, 201, 255, 41, 246, 60, 88, 106, 114, 40, 34, 208, 171, 220, 96, 79, 51, 43, 111, 58,
    202, 188, 108, 166, 106, 244, 199, 232, 210, 205, 34,
];
pub const MAINNET_BRIDGE_CIRCUIT_CONSTANT: [u8; 32] = [
    24, 156, 174, 88, 153, 131, 23, 29, 169, 129, 99, 251, 131, 113, 42, 186, 178, 135, 119, 232,
    88, 188, 239, 81, 104, 88, 58, 241, 5, 74, 233, 164,
];
pub const TESTNET4_BRIDGE_CIRCUIT_CONSTANT: [u8; 32] = [
    92, 102, 37, 253, 138, 39, 138, 72, 215, 200, 222, 202, 167, 70, 48, 125, 142, 146, 246, 215,
    107, 50, 244, 248, 45, 239, 38, 52, 210, 247, 43, 139,
];
