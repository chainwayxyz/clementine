...
fn main() {
    ...
    let res = parsed_tx.check_first_output_valid("ac6c0d42dc7c13ce95134b7ed720f0fb0f69e31f1207f4a4cd27b8b9d1480fe2");
    let first_address = parsed_tx.outputs[0].script_pub_key[2..parsed_tx.outputs[0].script_pub_key_size as usize].to_vec();
    let test_address = hex::decode("ac6c0d42dc7c13ce95134b7ed720f0fb0f69e31f1207f4a4cd27b8b9d1480fe2").unwrap();
