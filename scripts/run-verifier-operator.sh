...
export SERVER_CERT_PATH=${SERVER_CERT_PATH:="core/certs/client/client.pem"}
export SERVER_KEY_PATH=${SERVER_KEY_PATH:="core/certs/client/client.key"}
export CLIENT_CERT_PATH=${CLIENT_CERT_PATH:="core/certs/client/client.pem"}
export CLIENT_KEY_PATH=${CLIENT_KEY_PATH:="core/certs/client/client.key"}
export AGGREGATOR_CERT_PATH=${AGGREGATOR_CERT_PATH:="core/certs/aggregator/aggregator.pem"}
...
export NUM_ROUND_TXS=${NUM_ROUND_TXS:=3}
export NUM_KICKOFFS_PER_ROUND=${NUM_KICKOFFS_PER_ROUND:=100}
export NUM_SIGNED_KICKOFFS=${NUM_SIGNED_KICKOFFS:=2}
...
export BRIDGE_NONSTANDARD=${BRIDGE_NONSTANDARD:=true}
export TELEMETRY_HOST=0.0.0.0
export TELEMETRY_PORT=8081
export RUST_MIN_STACK=33554432
export RISC0_DEV_MODE=1
export EMERGENCY_STOP_ENCRYPTION_PUBLIC_KEY=025d32d10ec7b899df4eeb4d80918b7f0a1f2a28f6af24f71aa2a59c69c0d531
