...
export PGUSER=clementine
export PGPASSWORD=clementine
...
export BRIDGE_CIRCUIT_METHOD_ID_CONSTANT=ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
...
# Citrea
export CITREA_CHAIN_ID=5115
export CITREA_RPC_URL=https://rpc.testnet.citrea.xyz
export CITREA_LIGHT_CLIENT_PROVER_URL=https://light-client-prover.testnet.citrea.xyz/
...
export SECURITY_COUNCIL=1:50929b74c1a04954b78b4b6035e97a5e078a5a0f28ec96d547bfee9ace803ac0
export HEADER_CHAIN_PROOF_BATCH_SIZE=100

# Endpoints for aggregator
export VERIFIER_ENDPOINTS=https://127.0.0.1:17001,https://127.0.0.1:17002,https://127.0.0.1:17003,https://127.0.0.1:17004
export OPERATOR_ENDPOINTS=https://127.0.0.1:17005,https://127.0.0.1:17006

export DISABLE_NOFN_CHECK=1
export OPERATOR_WITHDRAWAL_FEE_SATS=100000

# System parameters
export NETWORK=regtest
export NUM_ROUND_TXS=200
export NUM_KICKOFFS_PER_ROUND=100
export NUM_SIGNED_KICKOFFS=5
export BRIDGE_AMOUNT=1000000000
export KICKOFF_AMOUNT=0
...
export LATEST_BLOCKHASH_TIMEOUT_TIMELOCK=360
export FINALITY_DEPTH=100
export START_HEIGHT=190
export GENESIS_HEIGHT=0
export GENESIS_CHAIN_STATE_HASH=5f7302ad16c8bd9ef2f3be00c8199a86f9e0ba861484abb4af5f7e457f8c2216
...
# TLS
export CA_CERT_PATH=core/certs/ca/ca.pem
export SERVER_CERT_PATH=core/certs/server/server.pem
export SERVER_KEY_PATH=core/certs/server/server.key
export CLIENT_CERT_PATH=core/certs/server/server.pem
export CLIENT_KEY_PATH=core/certs/server/server.key
export AGGREGATOR_CERT_PATH=core/certs/server/server.pem
export CLIENT_VERIFICATION=1
...
for i in "${!configs[@]}"; do
    ...
    if [ "$role" = "aggregator" ]; then
        echo "Waiting 30 second before starting aggregator..."
        sleep 30
    fi
