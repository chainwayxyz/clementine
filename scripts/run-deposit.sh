...
DEPOSIT_AMOUNT="10"
BQR_ALIAS=${BQR_ALIAS:="bitcoin-cli -regtest -rpcport=18443 -rpcuser=admin -rpcpassword=admin -rpcwallet=admin"}
BITCOIN_RPC_URL=${BITCOIN_RPC_URL:="http://127.0.0.1:18443/wallet/admin"}
