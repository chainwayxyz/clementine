...
pub(crate) enum TxDebugState {
    ...
    NoFundingSendFailed,
    NonstandardTestnet4SendSuccess,
    NonstandardTestnet4SendFailed,
    NonstandardTestnet4SendSubmitted,
    RbfPsbtBumpFailed,
...
impl TxDebugState {
    pub(crate) fn as_str(self) -> &'static str {
        match self {
            ...
            Self::NonstandardTestnet4SendSuccess => "nonstandard_testnet4_send_success",
            Self::NonstandardTestnet4SendFailed => "nonstandard_testnet4_send_failed",
            Self::NonstandardTestnet4SendSubmitted => "nonstandard_testnet4_send_submitted",
